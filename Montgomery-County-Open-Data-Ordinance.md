...
Measurement means to guantify any characteristic of an observable event, occurrence, or object by comparison to a reference standard.  
...
* (1) can be used to Increase agency accountability and responslveness; 
* (2) improves public knowledge ofthe agency and its operations; 
* (3) furthers the mission ofthe agency; 
...
(a) The Open Data Implementation Plan must address measures to maintain bandwidth availability ofthe web portal.
...
(a) A public data set made available on the web portal is provided for informational purposes. The County makes no express or implied warranty the completeness, accuracy, content, merchantability, or fitness for any particular purpose or use of any public data set made available on the web portal.
